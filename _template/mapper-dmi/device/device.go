...
func (d *DevPanel) start(ctx context.Context, dev *driver.CustomizedDev) {
	...
	var protocolConfig driver.TemplateProtocolConfig
	...
	var protocolCommonConfig driver.TemplateProtocolCommonConfig
...
func initTwin(ctx context.Context, dev *driver.CustomizedDev) {
	for _, twin := range dev.Instance.Twins {
		var visitorConfig driver.TemplateVisitorConfig
...
func setVisitor(visitorConfig *driver.TemplateVisitorConfig, twin *common.Twin, dev *driver.CustomizedDev) error {
