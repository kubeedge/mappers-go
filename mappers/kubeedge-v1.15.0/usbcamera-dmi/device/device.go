...
import (
	...
	dbInflux "github.com/kubeedge/usb/data/dbmethod/influxdb2"
	httpMethod "github.com/kubeedge/usb/data/publish/http"
	mqttMethod "github.com/kubeedge/usb/data/publish/mqtt"
	"github.com/kubeedge/usb/driver"
